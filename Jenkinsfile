pipeline {
  ...
  stages {
    ...
    post { 
        unsuccessful { 
                    sh '''cd /home/belhard/myproject/show && git config --global --add safe.directory /home/belhard/myproject/show && git config --global user.email "you@example.com" && git config --global user.name "ArtsiomBeladzedau" && git revert HEAD'''
                    sh '''
                      rm -rf /home/belhard/show
                      cp -prf /var/lib/jenkins/workspace/mytest/show /home/belhard/test
                      cd /home/belhard/test/show
